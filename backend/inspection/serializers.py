...
def serialize_inspection(inspection):
    ...
    return {
        ...
        "responses": responses,
        "meta": {
            "inspector_name": inspection.inspector_name or inspection.flat.inspector_name,
            "inspector_contact": inspection.inspector_contact or inspection.flat.inspector_contact,
            "company": inspection.company or inspection.flat.company,
            "fm_name": inspection.fm_name or inspection.flat.fm_name,
            "inspection_date": inspection.inspection_date or inspection.flat.inspection_date,
